...
import { daylightHours, MONTH_NAMES_JA, doyToDate } from "@/lib/solar";
...
export default function DaylightContourChart({
  ...
  // Pre-compute the daylight grid (independent of dayOfYear)
  ...
  useEffect(() => {
    ...
    g.append("rect")
      ...
      .on("mousemove", function (event: MouseEvent) {
        ...
        const clampedLat = Math.max(-90, Math.min(90, latVal));
        const hours = daylightHours(clampedLat, clampedDay);
